...
$("#answer01").on('click',function(){
  ...
  setTimeout(function(){
    ...
    switch(status){
      ...
      break;
      case '2':
      resultSet("ステージ部署","images/1x/hiru-icon.png");
      break;
      case '3':
      ...
      break;
      case '5':
      resultSet("BAR部署","images/1x/bar-icon.png");
      break;
      case '6':
      resultSet("カフェ部署","images/1x/cafe-icon.png");
      break;
      case '7':
      resultSet("PA部署","images/1x/pa-icon.png");
      break;
      case '8':
      quesSet(9,"家具にはこだわりがある?","けっこうある","そんなに...");
      break;
      case '9':
      resultSet("インテリア部署","images/1x/in-icon.png");
      break;
      case '10':
      resultSet("エクステリア部署","images/1x/ex-icon.png");
      break;
      case '11':
      quesSet(12,"イラストには自信がある？","割とある","そこまで...");
      break;
      case '12':
      resultSet("グラフィック部署","images/1x/gra-icon.png");
      break;
      case '13':
      quesSet(14,"どっちかといえば好きなのは？","さんすう","えいご");
      break;
      case '14':
      resultSet("web部署","images/1x/web-icon.png");
      break;
      case '15':
      resultSet("ディレクション部署","images/1x/d-icon.png");
      break;
      case '16':
      resultSet("運動会部署","images/1x/undo-icon.png");
      break;
...
$("#answer03").on('click',function(){
  ...
  setTimeout(function(){
    ...
    switch(status){
      ...
      break;
      case '10':
      resultSet("ブース部署","images/1x/booth-icon.png");
      break;
      case '11':
      ...
      break;
      case '14':
      resultSet("映像部署","images/1x/movie-icon.png");
      break;
      case '15':
      resultSet("ワークショップ部署","images/1x/work-icon.png");
      break;
      case '16':
